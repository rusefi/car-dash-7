...
extern const unsigned char image_indbatt[]; // BITMAP_INDBATT_ID = 2, Size: 49x38 pixels
extern const unsigned char image_indbatt_extra_data[];
extern const unsigned char image_inddtc[]; // BITMAP_INDDTC_ID = 3, Size: 75x36 pixels
extern const unsigned char image_inddtc_extra_data[];
extern const unsigned char image_indect[]; // BITMAP_INDECT_ID = 4, Size: 45x40 pixels
extern const unsigned char image_indect_extra_data[];
extern const unsigned char image_indfuel[]; // BITMAP_INDFUEL_ID = 5, Size: 32x40 pixels
extern const unsigned char image_indfuel_extra_data[];
extern const unsigned char image_indhigh[]; // BITMAP_INDHIGH_ID = 6, Size: 49x28 pixels
extern const unsigned char image_indhigh_extra_data[];
extern const unsigned char image_indleft[]; // BITMAP_INDLEFT_ID = 7, Size: 65x42 pixels
extern const unsigned char image_indleft_extra_data[];
extern const unsigned char image_indlow[]; // BITMAP_INDLOW_ID = 8, Size: 48x30 pixels
extern const unsigned char image_indlow_extra_data[];
extern const unsigned char image_indoil[]; // BITMAP_INDOIL_ID = 9, Size: 67x28 pixels
extern const unsigned char image_indoil_extra_data[];
extern const unsigned char image_indpark[]; // BITMAP_INDPARK_ID = 10, Size: 56x41 pixels
extern const unsigned char image_indpark_extra_data[];
extern const unsigned char image_indright[]; // BITMAP_INDRIGHT_ID = 11, Size: 65x42 pixels
extern const unsigned char image_indright_extra_data[];
extern const unsigned char image_needel[]; // BITMAP_NEEDEL_ID = 12, Size: 34x290 pixels
extern const unsigned char image_needel_extra_data[];
extern const unsigned char image_race_dash_full[]; // BITMAP_RACE_DASH_FULL_ID = 13, Size: 1027x617 pixels
